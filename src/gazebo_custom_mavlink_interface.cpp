...
void GazeboMavlinkInterface::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
  ...
  // custom topics -------------------------------------------------------------
  tvc_status_sub_topic_ = "~/" + model_->GetName() + "/tvc_status";
  ...
  // Custom Subscribers --------------------------------------------------------
  // subscribe to messages sent from TVC controller
  tvc_status_sub_ = node_handle_->Subscribe<sensor_msgs::msgs::TVCStatus>(
    tvc_status_sub_topic_, &GazeboMavlinkInterface::TVCStatusCallback, this);
  ...
  // Publish TVC target
  tvc_target_pub_ = node_handle_->Advertise<sensor_msgs::msgs::TVCTarget>(
    tvc_target_pub_topic_, 1);
...
// Custom callbacks ------------------------------------------------------------
void GazeboMavlinkInterface::TVCStatusCallback(TVCStatusPtr &msg) {
  _actuator_status_1 = msg->actuator_status_1();
  _actuator_target_1 = msg->actuator_target_1();
  _actuator_current_1 = msg->actuator_current_1();
  _actuator_velocity_1 = msg->actuator_velocity_1();

  _actuator_status_2 = msg->actuator_status_2();
  _actuator_target_2 = msg->actuator_target_2();
  _actuator_current_2 = msg->actuator_current_2();
  _actuator_velocity_2 = msg->actuator_velocity_2();
}
...
void GazeboMavlinkInterface::sendTVCTarget() {
  sensor_msgs::msgs::TVCTarget tvc_target_msg;

  tvc_target_msg.set_actuator_1_target(_linear_actuator_target[0]);
  tvc_target_msg.set_actuator_2_target(_linear_actuator_target[1]);

  tvc_target_pub_->Publish(tvc_target_msg);
}
...
void GazeboMavlinkInterface::SendActuatorStatus() {
  ...
  status_msg.actuator_1 = _actuator_status_1;
  status_msg.actuator_1_target = _actuator_target_1;
  status_msg.actuator_1_current = _actuator_current_1;
  status_msg.actuator_1_velocity = _actuator_velocity_1;

  status_msg.actuator_2 = _actuator_status_1;
  status_msg.actuator_2_target = _actuator_target_1;
  status_msg.actuator_2_current = _actuator_current_1;
  status_msg.actuator_2_velocity = _actuator_velocity_1;
