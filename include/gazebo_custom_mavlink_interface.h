...
// custom types ----------------------------------------------------------------
typedef const boost::shared_ptr<const sensor_msgs::msgs::TVCStatus>
    TVCStatusPtr;
...
private:
  ...
  void TVCStatusCallback(TVCStatusPtr &msg);
  ...
  transport::PublisherPtr tvc_target_pub_;
  ...
  // custom topic names --------------------------------------------------------
  std::string tvc_status_sub_topic_;
